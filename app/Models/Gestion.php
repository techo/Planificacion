...
class Gestion extends BaseModel
{
    ...
    /* Query datos tendencias */
    public function Tendencias($aParam)
    {
        /* 2019 */
        $sql   = "SELECT ";
        $sql  .= "'2019' AS 'Ano', ";
        ...
        $sql  .= "tipo.tipo, ";
        $sql  .= "CASE ";
        $sql  .= "WHEN dplanificacion.id_pais = 1 THEN 'Brasil' ";
        $sql  .= "WHEN dplanificacion.id_pais = 2 THEN 'Chile' ";
        $sql  .= "WHEN dplanificacion.id_pais = 3 THEN 'El Salvador' ";
        $sql  .= "WHEN dplanificacion.id_pais = 4 THEN 'Argentina' ";
        $sql  .= "WHEN dplanificacion.id_pais = 5 THEN 'Oficina Internacional' ";
        $sql  .= "WHEN dplanificacion.id_pais = 6 THEN 'Bolivia' ";
        $sql  .= "WHEN dplanificacion.id_pais = 7 THEN 'Colombia' ";
        $sql  .= "WHEN dplanificacion.id_pais = 8 THEN 'Costa Rica' ";
        $sql  .= "WHEN dplanificacion.id_pais = 9 THEN 'Ecuador' ";
        $sql  .= "WHEN dplanificacion.id_pais = 10 THEN 'Guatemala' ";
        $sql  .= "WHEN dplanificacion.id_pais = 11 THEN 'Haiti' ";
        $sql  .= "WHEN dplanificacion.id_pais = 12 THEN 'Honduras' ";
        $sql  .= "WHEN dplanificacion.id_pais = 13 THEN 'Mexico' ";
        $sql  .= "WHEN dplanificacion.id_pais = 14 THEN 'Nicaragua' ";
        $sql  .= "WHEN dplanificacion.id_pais = 15 THEN 'Panama' ";
        $sql  .= "WHEN dplanificacion.id_pais = 16 THEN 'Paraguay' ";
        $sql  .= "WHEN dplanificacion.id_pais = 17 THEN 'Peru' ";
        $sql  .= "WHEN dplanificacion.id_pais = 18 THEN 'Republica Dominicana' ";
        $sql  .= "WHEN dplanificacion.id_pais = 19 THEN 'Uruguay' ";
        $sql  .= "WHEN dplanificacion.id_pais = 20 THEN 'EUA' ";
        $sql  .= "WHEN dplanificacion.id_pais = 21 THEN 'Venezuela' ";
        $sql  .= "WHEN dplanificacion.id_pais = 22 THEN 'Europa' ";
        $sql  .= "ELSE '' ";
        $sql  .= "END AS 'Pais' ";
        $sql  .= "FROM dplanificacion ";
        $sql  .= "INNER JOIN indicador ON indicador.id = dplanificacion.id_indicador ";
        $sql  .= "INNER JOIN tipo ON indicador.id_tipo = tipo.id ";
        $sql  .= "INNER JOIN pilar ON pilar.id = indicador.id_pilar ";
        $sql  .= "WHERE dplanificacion.id_cplanificacion = 11 ";
        ...
        $sql  .= "INNER JOIN tipo ON indicador.id_tipo = tipo.id ";
        $sql  .= "INNER JOIN pilar ON pilar.id = indicador.id_pilar ";
        $sql  .= "WHERE dplanificacion.id_cplanificacion = 12 ";
        ...
        $sql  .= "INNER JOIN tipo ON indicador.id_tipo = tipo.id ";
        $sql  .= "INNER JOIN pilar ON pilar.id = indicador.id_pilar ";
        $sql  .= "WHERE dplanificacion.id_cplanificacion = 13 ";
