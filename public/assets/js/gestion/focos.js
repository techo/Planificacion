...
function Processar(tipo)
{
	...
	if(tipo == 'Sede')
	{
		...
		$.ajax({
			type: "POST",
			data: {'idPais' : idPais, 'idAno' : idAno, 'idSede' : idSede},
			url: "/visual/focos/sede",
			dataType: "json",
			success: function(resposta)
			{
				$('#foco').html(resposta['html']);
				
				// Exibir as grids
				$(resposta['resultado']).each(function(index,element){
					var headerMenu = [
						{
					...
					tabledata = resposta['resultado'][index];
					
					$('#config').css('display','block');
					
					var table = new Tabulator("#foco"+index, {
						layout:"fitData",
					    data:tabledata,
					    movableRows:true,
					    movableColumns:true,
	...
	else if(tipo == 'Pais')
	{
		...
		$.ajax({
			type: "POST",
			data: {'idPais' : idPais, 'idAno' : idAno},
			url: "/visual/focos/pais",
			dataType: "json",
			success: function(resposta)
			{
				$('#foco').html(resposta['html']);
