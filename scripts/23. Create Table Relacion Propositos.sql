...
CREATE TABLE rlproposito (
   ...
   id_proposito INT(10) NOT NULL COMMENT 'Id Proposito',
  ...
  PRIMARY KEY (id),
  FOREIGN KEY (id_proposito) REFERENCES proposito(id)
) ENGINE=INNODB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='tabela de relacion de propositos com kpis';