...
CREATE TABLE rlaprendizaje (
   ...
   id_aprendizaje INT(10) NOT NULL COMMENT 'Id Proceso',
   ids_procesos VARCHAR(900) NOT NULL COMMENT 'Id Propuestas',
   ids_aprendizajes VARCHAR(900) NOT NULL COMMENT 'Id Procesos',
  ...
  PRIMARY KEY (id)
) ENGINE=INNODB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='tabela de relacion de aprendizajes com kpis';