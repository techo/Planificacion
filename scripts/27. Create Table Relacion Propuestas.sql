...
CREATE TABLE rlpropuesta (
   ...
   id_propuesta INT(10) NOT NULL COMMENT 'Id Propuesta',
   ids_proposito VARCHAR(900) NOT NULL COMMENT 'Id Proposito',
  ...
  PRIMARY KEY (id)
) ENGINE=INNODB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='tabela de relacion de propuestas com kpis';